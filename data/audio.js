App.register('audio', {
    ...
    methods: [
        { name: 'play_oneshot', ret: 'void', params: '(path: String)', desc: 'Plays a short sound effect.', example: 'audio.play_oneshot("assets/sfx.wav")', implemented: 'v0.0.1 (3)' },
        { name: 'play_stream', ret: 'void', params: '(path: String)', desc: 'Streams a music file.', example: 'audio.play_stream("assets/music.mp3")', implemented: 'v0.0.1 (3)' },
