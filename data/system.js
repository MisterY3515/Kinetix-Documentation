...
if os == "Windows" {
    ...
    methods: [
        ...
        { name: 'os_version', ret: 'String', params: '()', desc: 'Returns the OS version string.', example: 'println(system.os_version()) // "10.0.19045"', since: 'v0.0.1 (3)' },
        { name: 'hostname', ret: 'String', params: '()', desc: 'Returns the network hostname of the machine.', example: 'println(system.hostname())', since: 'v0.0.1 (3)' },
        { name: 'user_name', ret: 'String', params: '()', desc: 'Returns the current logged-in user name.', example: 'println("Hello " + system.user_name())', since: 'v0.0.1 (3)' },
