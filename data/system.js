...
let cores = system.get_hardware_info().cpu_cores`,
    methods: [
        ...
        { name: 'os.isLinux', ret: 'bool', params: '()', desc: 'Returns true if the host OS is Linux.', details: 'Resolved at compile-time via Rust <code>cfg!(target_os = "linux")</code>. Supports compile-time branch elimination.', example: 'if system.os.isLinux() { print("Linux!") }', implemented: 'v0.0.7 (23)' },
        { name: 'os.isMac', ret: 'bool', params: '()', desc: 'Returns true if the host OS is macOS.', details: 'Resolved at compile-time via Rust <code>cfg!(target_os = "macos")</code>. Supports compile-time branch elimination.', example: 'if system.os.isMac() { print("macOS!") }', implemented: 'v0.0.7 (23)' }
    ],
    properties: [
